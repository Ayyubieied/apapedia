...
public class CartRestController {
    ...
    public ResponseEntity<CartResponseDTO> createCart(@PathVariable("idUser") UUID idUser, @RequestBody CreateCartRequestDTO cartDTO){
        var cart = cartMapper.createCartRequestDTOToCart(cartDTO);
        cart.setCartId(cartService.retrieveCartId(idUser));
